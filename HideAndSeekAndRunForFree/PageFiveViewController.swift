...
class PageFiveViewController: UIViewController {
    ...
    @IBOutlet var pageFiveText: UILabel!
...
extension PageFiveViewController: AVSpeechSynthesizerDelegate {
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, willSpeakRangeOfSpeechString characterRange: NSRange, utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageFiveText.attributedText = attributed
        }
    }
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, didFinish utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageFiveText.attributedText = fullText
        }
    }
}
