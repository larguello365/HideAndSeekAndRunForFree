...
class PageFourViewController: UIViewController {
    ...
    @IBOutlet var pageFourText: UILabel!
...
extension PageFourViewController: AVSpeechSynthesizerDelegate {
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, willSpeakRangeOfSpeechString characterRange: NSRange, utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageFourText.attributedText = attributed
        }
    }
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, didFinish utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageFourText.attributedText = fullText
        }
    }
}
