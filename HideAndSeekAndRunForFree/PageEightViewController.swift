...
class PageEightViewController: UIViewController {
    @IBOutlet var playButton: UIButton!
    @IBOutlet var homeButton: UIButton!
    @IBOutlet var pageEightText: UILabel!
...
extension PageEightViewController: AVSpeechSynthesizerDelegate {
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, willSpeakRangeOfSpeechString characterRange: NSRange, utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageEightText.attributedText = attributed
        }
    }
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, didFinish utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageEightText.attributedText = fullText
        }
    }
}
