...
class PageSevenViewController: UIViewController {
    ...
    @IBOutlet var pageSevenText: UILabel!
...
extension PageSevenViewController: AVSpeechSynthesizerDelegate {
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, willSpeakRangeOfSpeechString characterRange: NSRange, utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageSevenText.attributedText = attributed
        }
    }
    ...
    func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, didFinish utterance: AVSpeechUtterance) {
        ...
        DispatchQueue.main.async {
            self.pageSevenText.attributedText = fullText
        }
    }
}
